...
class DeletingACustomerTest extends TestCase
{
    ...
    /** */
    public function testAuthenticated_can_delete_a_customer()
    {
    ...
    /** */
    public function testAuthenticated_user_can_delete_a_note_from_a_customer()
    {
        create(Note::class);
    ...
    /** */
    public function testAuthenticated_can_delete_the_notes_of_a_customer()
    {
    ...
    /** */
    public function testAuthenticated_user_can_delete_a_intake_from_a_customer()
    {
