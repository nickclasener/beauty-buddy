...
<div class="flex items-center justify-center flex-wrap h-screen fixed top-0 w-full">
	<div
			 class="flex items-center justify-center bg-white p-4 sm:p-8 md:p-12 lg:p-16 flex-col shadow-2xl border border-gray-200 fixed">
		...
		<form method="POST"
			...
			<div class="mb-6 text-center">
				<div class="relative w-full mb-1">
					<input id="email"
								 ...
								 name="email"
								 {{-- FIXME: demo login --}}
								 value="{{ 'example@example.com' ?: old('email') }}"
			...
			<a href="{{ route('password.request', false) }}"
				 class="font-light text-sm">{{ __('Forgot Your Password?') }}
			</a>
			@endif
		</form>
	</div>
