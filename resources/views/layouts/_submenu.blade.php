<div class="lg:sticky lg:top-0 lg:z-10 lg:pt-16 -mx-4 lg:mx-0">
	...
	>
		...
		<a class="no-underline lg:py-2 {{ active_route_set_class('note.index') }} flex items-center justify-center flex-grow text-center"
		...
		<a class="no-underline {{ active_route_set_class('huidanalyse.index') }} flex justify-center flex-grow text-center items-center"
		   ...
		   data-target="toggle.deactivate"
		>{{ svg_image('lineicons/stethoscope', 'h-8'. active_icon_route_set_class('huidanalyse.index')) }}
		</a>
		...
		<a class="no-underline lg:py-2 {{ active_route_set_class('intake.show') }} flex items-center justify-center text-center flex-grow "
		   href="#"
