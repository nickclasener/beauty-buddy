...
//	Route::get('notities/search', function (NotesRepository $repository) {
	...
	Route::match(['put', 'patch'], '/notities/{note}', 'NotesController@update')->name('notities.update');
	...
	Route::match(['put', 'patch'], '/klanten/{customer}/intake/{intake}', 'IntakeController@update')->name('intake.update');
